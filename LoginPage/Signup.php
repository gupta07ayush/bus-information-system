  ...
  <div class="container__child signup__form">
	...
	<div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" id="email" placeholder="email@creative.com" required />
      </div>
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="cpassword" name="cpassword" id="cpassword" placeholder="********" required />
      </div>
      <div class="m-t-lg">
        <ul class="list-inline">
          ...
          <li>
            <a class="signin__link" href="login.php">I am already a member</a>
          </li>
        </ul>
      </div>
    </form>  
				...
				if($query_run)
					{
						...
						{
							$query = "insert into user values('$firstname','$lastname','$email','$username','$password')";
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
